...
userRoute.post('/storeNotificationData', doctorController.UpdateDoctorStatusAfterAdminApprove);
...
userRoute.get('/stripe-webhook',paymentController.handleStripeWebhookUpdateUser)
