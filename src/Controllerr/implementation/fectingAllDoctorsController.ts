...
import { IfectingAllDoctorsService } from '../../Servicess/interface/fectingAllDoctorsInterFace';

export default class FetchController  {
    private readonly FetchDoctorService: IfectingAllDoctorsService;

    constructor(FetchDoctorService: IfectingAllDoctorsService) {
