...
import { IDoctorPaymentRepository } from "../interface/IDoctorAndUserPaymentRepository";
import { UserResponse } from "../../entities/user_interface";

export default class DoctorPaymentRepository
  implements IDoctorPaymentRepository
{
