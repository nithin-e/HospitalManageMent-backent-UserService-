import { IUserBlockAndUnblockService } from "../interface/IBlockAndUnblockservice.";

import { IUserBlockAndUnblockRepository } from "../../repositories/interface/IBlockAndUnblockRepository.";
